    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info() // 基本信息配置
                        .title("化学合成-反应分类系统") // 标题
                        .description("单个反应预测、批量反应预测、训练分类模型") // 描述 Api 接口文档的基本信息
                        .version("v1.0.0") // 版本
                        .contact(new Contact().name("hpk").email("hanpingkun@163.com"))
                );
    }

    /**
     * 启动项目后可以直接点击链接跳转，而不用自己到浏览器输入路径
     */
    @Override
